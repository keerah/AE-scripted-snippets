...
// and another version of this script with the negative value in line 3 (var = -4;)
// on another KBar button to Nudge backwards

var ff = 4; // a fraction of a frame length to nudge by, positive value to nudge forward, negative - backward
